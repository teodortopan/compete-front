...
const Profile = ({ username, setLoginMessage, loginMessage, setUserId, userData, setUserData }) => {
  ...
  const logOut = () => {
    ...
    localStorage.setItem('eventTitle', '')
  ...
  return (
    <div className="profile-container">
      {loginMessage && <div className="login-banner">{loginMessage}</div>}
